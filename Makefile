...
Makefile.conf: _CoqProject
	coq_makefile -f _CoqProject Basics.v BasicsTest.v Induction.v InductionTest.v Lists.v ListsTest.v Poly.v PolyTest.v Preface.v Tactics.v TacticsTest.v -o Makefile
