...
Makefile.conf: _CoqProject
	coq_makefile -f _CoqProject Basics.v BasicsTest.v IndProp.v IndPropTest.v Induction.v InductionTest.v Lists.v ListsTest.v Logic.v LogicTest.v Poly.v PolyTest.v Preface.v Tactics.v TacticsTest.v -o Makefile
