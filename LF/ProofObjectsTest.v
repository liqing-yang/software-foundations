...
check_type @eveni_8 ((eveni 8)).
idtac "Assumptions:".
Abort.
Print Assumptions eveni_8.
Goal True.
idtac " ".
...
idtac "#> Props.ex_eveni_Sn".
idtac "Possible points: 2".
check_type @Props.ex_eveni_Sn ((exists n : nat, eveni (S n))).
idtac "Assumptions:".
Abort.
Print Assumptions Props.ex_eveni_Sn.
Goal True.
idtac " ".
