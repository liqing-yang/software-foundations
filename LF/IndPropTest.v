...
check_type @eveni_double ((forall n : nat, eveni (double n))).
idtac "Assumptions:".
Abort.
Print Assumptions eveni_double.
Goal True.
idtac " ".
...
idtac "#> SSSSev__even".
idtac "Possible points: 1".
check_type @SSSSev__even ((forall n : nat, eveni (S (S (S (S n)))) -> eveni n)).
idtac "Assumptions:".
Abort.
...
idtac "#> ev5_nonsense".
idtac "Possible points: 1".
check_type @ev5_nonsense ((eveni 5 -> 2 + 2 = 9)).
idtac "Assumptions:".
Abort.
...
check_type @eveni_sum ((forall n m : nat, eveni n -> eveni m -> eveni (n + m))).
idtac "Assumptions:".
Abort.
Print Assumptions eveni_sum.
Goal True.
idtac " ".

idtac "-------------------  eveni_eveni__eveni  --------------------".
idtac " ".

idtac "#> eveni_eveni__eveni".
idtac "Advanced".
idtac "Possible points: 3".
check_type @eveni_eveni__eveni ((forall n m : nat, eveni (n + m) -> eveni n -> eveni m)).
idtac "Assumptions:".
Abort.
Print Assumptions eveni_eveni__eveni.
Goal True.
idtac " ".
